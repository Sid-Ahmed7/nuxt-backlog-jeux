...
<template>
  <div class="w-full bg-[#2d3a3f] text-white p-8 flex flex-col gap-8 overflow-y-auto">
    <FilterItems title="Filtrer par plateforme" :items="platforms" v-model="selectedPlatform" />
    <FilterItems title="Filtrer par genre" :items="genres" v-model="selectedGenreRef" />
    <FilterItems title="Filtrer par mode de jeu" :items="gameModes" v-model="selectedGameMode" />
    <FilterItems title="Filtrer par theme" :items="themes" v-model="selectedTheme" />
  </div>
</template>
